...
-- QUERY 1
SELECT product_master._description AS 'Product Name', SUM(sales_order_details._qty_disp) AS 'Total Quantity Sold'
FROM sales_order_details
JOIN product_master
ON sales_order_details._product_no = product_master._product_no
GROUP BY product_master._description;

-- QUERY 2
SELECT product_master._description AS 'Product Name', SUM(sales_order_details._qty_disp * product_master._sell_price) AS 'Sold Value'
FROM sales_order_details
JOIN product_master
ON sales_order_details._product_no = product_master._product_no
GROUP BY product_master._description;
...
-- QUERY 3
SELECT AVG(sales_order_details._qty_disp) AS 'Average Quantity Sold',  client_master._client_no AS 'Client Number'
FROM sales_order_details
JOIN sales_order
ON sales_order_details._s_order_no = sales_order._s_order_no
JOIN client_master
ON sales_order._client_no = client_master._client_no
JOIN product_master
ON sales_order_details._product_no = product_master._product_no
GROUP BY client_master._client_no
HAVING SUM(sales_order_details._qty_disp * product_master._sell_price) <= 15000;

-- QUERY 4
SELECT product_master._description AS 'Product Name'
FROM sales_order_details
JOIN sales_order
ON sales_order_details._s_order_no = sales_order._s_order_no
JOIN product_master
...
JOIN client_master
ON sales_order._client_no = client_master._client_no
WHERE client_master._name = 'Ivan';


-- QUERY 5
SELECT client_master._name AS 'Client Name'
FROM sales_order_details
JOIN sales_order
ON sales_order_details._s_order_no = sales_order._s_order_no
JOIN product_master
...
JOIN client_master
ON sales_order._client_no = client_master._client_no
WHERE product_master._description = 'CD Drive';

-- QUERY 6
SELECT product_master._description AS 'Product Name', sales_order_details._qty_disp AS 'Quantity Sold'
FROM sales_order_details
JOIN sales_order
ON sales_order_details._s_order_no = sales_order._s_order_no
JOIN product_master
...
JOIN client_master
ON sales_order._client_no = client_master._client_no
WHERE client_master._name = 'Vandana' OR client_master._name = 'Ivan';

-- QUERY 7
SELECT product_master._description AS 'Product Name', SUM(sales_order_details._qty_disp) AS 'Quantity Sold'
FROM product_master
JOIN sales_order_details
ON sales_order_details._product_no = product_master._product_no
GROUP BY product_master._product_no;


-- QUERY 8
SELECT product_master._product_no AS 'Product Number', product_master._description AS 'Product Name', SUM(sales_order_details._qty_disp) AS 'Quantity Ordered/Sold'
FROM product_master
JOIN sales_order_details
ON sales_order_details._product_no = product_master._product_no
GROUP BY product_master._product_no;
...
-- QUERY 9
SELECT sales_order._s_order_no AS 'Order Number', DATE(sales_order._s_order_date) AS 'Day of Order'
FROM sales_order;

-- QUERY 10
SELECT sales_order._s_order_no AS 'Order Number', DATE(sales_order._dely_date) AS 'Day of Delivery'
FROM sales_order;
